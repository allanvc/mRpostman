...
#'     searchOlderThan(seconds = 3600)
#'
#' }
#'
#' @export
#'
searchOlderThan <- function(imapconf, seconds, negate = FALSE, by = "MSN",
  ...
  h <- define_searchrequest_within(operation = "OLDER",

#' Search WITHIN a time period (OLDER) (INTERNAL HELPER)
...
#'   Default is \code{1}.
#' @noRd
search_older_than_int <- function(self, seconds, negate, use_uid, flag, esearch,
                                  retries) {
  ...
  assert_capability(self, "WITHIN", command = "search_older_than",

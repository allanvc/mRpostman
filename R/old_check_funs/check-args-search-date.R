#' @title Date Search Arguments Check
#'
#' @description Internal helper function for checking arguments used in search
#'     functions.
#'
...
#' @keywords internal
#'
check_args_search_date <- function(date_char, negate, use_uid, flag, esearch, retries) {

  # checks
  assertthat::assert_that(
    grepl(pattern = "[\\d]{2}-[a-zA-Z]{3}-[\\d]{4}", date_char, perl = TRUE),

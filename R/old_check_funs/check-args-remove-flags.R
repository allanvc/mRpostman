#' @title Remove Flags Arguments Check
#'
#' @description Internal helper function for checking the arguments
#'     used in \code{\link{remove_flags}} function.
#'
...
#'     \code{"MSN"}.
#' @param flags_to_unset A character \code{vector} containing one ore more flag names
#'     to be removed from the specified message ids.
...
#' @keywords internal
#'
check_args_remove_flags <- function(msg_id, by, flags_to_unset, retries) {

...
#'     searchSentBefore(date_char = "17-Apr-2012",
#'                      negate = TRUE,
#'                      flag = "UNANSWERED")
#'
#' }
...
#' @export
#'
searchSentBefore <- function(imapconf, date_char, negate = FALSE,
                             by = "MSN", flag = NULL, esearch = FALSE,
                             return_imapconf = TRUE, retries = 2){

  check_args_searchDate(imapconf, date_char, negate, by, flag,

...
#'     searchSince(date_char = "17-Apr-2012")
#'
#' # search 2
#' result2 <- imapconf %>%
#'     selectMailbox(mbox = "Inbox") %>%
#'     searchSince(date_char = "17-Jun-2019", flag = "FLAGGED")
...
#' @export
#'
searchSince <- function(imapconf, date_char, negate = FALSE, by = "MSN",
  ...
  h <- define_searchrequest_date(operation = "SINCE",

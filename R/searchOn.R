...
#'     searchOn(date_char = "17-Dec-2003")
#'
#' # search 2 (mailboxes with compound names)
#' result2 <- imapconf %>%
#'     selectMailbox(mbox = "Special Mailbox") %>%
#'     searchOn(date_char = "17-Sep-2018", flag = "UNDELETED")
...
#' @export
#'
searchOn <- function(imapconf, date_char, negate = FALSE, by = "MSN",
  ...
  h <- define_searchrequest_date(operation = "ON",

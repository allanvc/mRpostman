#' @description Delete a mail folder (INTERNAL HELPER)
#' @param name A string containing the name of the mail folder to be deleted.
...
#'   Default is \code{1}.
#' @noRd
delete_folder_int <- function(self, name, mute, retries) {
  ...
  response <- imap_exec(self, customrequest = paste0('DELETE ', name2),

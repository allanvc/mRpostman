...
#'
#' # search
#' results <- search_sent_before(date_char = "17-Apr-2012",
#'                               negate = TRUE,
#'                               flag = "UNANSWERED")
#'
#' }
...
#' @export
#'
search_sent_before <- function(date_char, negate = FALSE, by = "MSN",
                               flag = NULL, esearch = FALSE, retries = 2) {

  check_args_search_date(date_char, negate, by, flag,
                         esearch, retries)

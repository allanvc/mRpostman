...
#'     remove_flags(flags_to_unset = c("\\RECENT", "$NotPhishing"))
#'     # system flags have double backslashes
#'     # keywords(custom flags) doesn't
#'
#' }
#'
#' @export
#'
remove_flags <- function(msg_id, by = "MSN", flags_to_unset, retries = 2) {

  check_args_remove_flags(msg_id, by, flags_to_unset, retries)

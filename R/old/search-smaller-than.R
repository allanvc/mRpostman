...
#'
#' @description Search for messages by bytes size.
#'
...
#'
#' # search
#' results <- search_smaller_than(size = 512000) # smaller than 512KB
#'
#' }
#'
#' @export
#'
search_smaller_than <- function(size, negate = FALSE, by = "MSN", flag = NULL,
  ...
  define_out <- define_searchrequest_size(operation = "SMALLER", size = size,
                                 negate = negate, by = by, flag = flag,

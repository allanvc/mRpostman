...
#'
#' # search 1
#' result1 <- search_on(date_char = "17-Dec-2003")
#'
#' # search 2 (mailboxes with compound names)
#' result2 <- search_on(date_char = "17-Sep-2018", flag = "UNDELETED")
...
#' @export
#'
search_on <- function(date_char, negate = FALSE, by = "MSN", flag = NULL,
  ...
  define_out <- define_searchrequest_date(operation = "ON",

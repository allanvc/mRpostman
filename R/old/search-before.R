...
#'
#' # search 1
#' result1 <- search_before(date_char = "17-Apr-2012")
#'
#' # search 2 (brazilian portuguese example -- mailboxes with compound names)
#' result2 <- search_before(date_char = "17-Dec-2018", flag = "ANSWERED")
#' # depending on results, it might be necessary to increase buffersize
#'
#' }
#'
#' @export
#'
search_before <- function(date_char, negate = FALSE, by = "MSN", flag = NULL,
  ...
  define_out <- define_searchrequest_date(operation = "BEFORE",

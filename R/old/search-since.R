...
#'
#' # search 1
#' result1 <- search_since(date_char = "17-Apr-2012")
#'
#' # search 2
#' result2 <- search_since(date_char = "17-Jun-2019", flag = "FLAGGED")
...
#' @export
#'
search_since <- function(date_char, negate = FALSE, by = "MSN",
  ...
  define_out <- define_searchrequest_date(operation = "SINCE",

...
#'
#' # search
#' results <- search_string(section_or_field = "FROM",
#'                          string = "michelle@@hotmail.com",
#'                          negate = TRUE
#'                          ) # not FROM "michelle@@hotmail.com"
#'
#' }
#'
#' @export
#'
search_string <- function(section_or_field, string, negate = FALSE, by = "MSN",
                          esearch = FALSE, retries = 2) {

  check_args_search_string(section_or_field, string, negate, by, esearch, retries)
  ...
  define_out <- define_searchrequest_string(section_or_field = section_or_field,

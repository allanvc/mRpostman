...
#'     section or field.
#'
#' @inheritParams check_args_searchString
#'
...
#'     searchString(section_or_field = "FROM", string = "michelle@@hotmail.com",
...
#' @export
#'
searchString <- function(imapconf, section_or_field, string, negate = FALSE,
                         by = "MSN", esearch = FALSE, return_imapconf = TRUE,
                         retries = 2){

  check_args_searchString(imapconf, section_or_field, string, negate, by, esearch,
  ...
  h <- define_searchrequest_string(section_or_field = section_or_field,
                                   string = string, negate = negate,

...
#'     \code{verbose = TRUE} in \link{configureIMAP} function, flags appear
...
#'     flags without starting with "\\"). This is the case of \link{addFlags},
#'     \link{removeFlags}, and \link{replaceFlags}
#'

...
#'   Default is \code{1}.
#' @noRd
search_sent_period_int <- function(self, since_date_char, before_date_char, negate,
                                   use_uid, flag, esearch, retries) {

  check_args(since_date_char = since_date_char, before_date_char = before_date_char,
             negate = negate, use_uid = use_uid, flag = flag, esearch = esearch,
             retries = retries)
  ...
  define_out <- define_searchrequest_period(operation1 = "SENTSINCE",

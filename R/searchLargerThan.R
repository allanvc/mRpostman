...
#'     searchLargerThan(size = 512000, flag = "UNSEEN") # larger than 512KB
#'
#' }
#'
#' @export
#'
searchLargerThan <- function(imapconf, size, negate = FALSE, by = "MSN",
  ...
  h <- define_searchrequest_size(operation = "LARGER",

...
#'
#' @inherit check_args_searchDate description return
#'
...
#'     \code{\link{listServerCapabilities}}.
...
#' @keywords internal
#'
check_args_searchString <- function(imapconf, section_or_field, string,
                                    negate, by, esearch, return_imapconf, retries){
  ...
  assertthat::assert_that(
    ...
    msg='"section_or_field" argument must be a character. See mrpostman::section_field_options().')

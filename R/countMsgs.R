...
#'
#' @note \code{copyMsg} uses \code{ESEARCH} extension. Check if your server
#'     supports ESEARCH capability with \link{listServerCapabilities}.
#'
...
#'     countMsgs(by = "UID", flag = "SEEN")
#'
#' }
#'
#' @export
#'
countMsgs <- function(imapconf, by = "MSN", flag, retries = 2){

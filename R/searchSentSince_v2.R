...
#' # configure IMAP
#' library(mRpostman)
#' imapconf <- configureIMAP(url="url="imaps://export.imap.aol.com"",
...
#'     searchSentSince(date_char = "17-Apr-2012")
#'
#' # search 2
#' result2 <- imapconf %>%
#'     selectMailbox(mbox = "Inbox") %>%
#'     searchSentSince(date_char = "17-Jun-2019", flag = "FLAGGED")
#'
#' }
#'
#' @export
#'
searchSentSince <- function(imapconf, date_char, negate = FALSE,
  ...
  h <- define_searchrequest_date(operation = "SENTSINCE",

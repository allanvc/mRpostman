...
#'
#' @inheritParams check_args_copyMsg
#'
...
#'     copyMsg(imapconf = imapconf, msg_id = msg_id, to_mbox = "INBOX")
#'
#' }
#'
#' @export
#'
copyMsg <- function(imapconf, msg_id, by = "MSN", to_mbox, reselect_mbox = FALSE,
                    logical_output = TRUE, retries = 2){

  check_args_copyMsg(imapconf, msg_id, by, to_mbox, logical_output,
                     retries)

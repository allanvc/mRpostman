...
#'
#' @inherit check_args_fetchFullMsg description return
#'
...
#'     \code{"MSN"}.
#' @param fields A character vector specifying which field(s) to fetch from
...
#' @keywords internal
#'
check_args_fetchMsgHeader <- function(imapconf, msg_id, by, fields,

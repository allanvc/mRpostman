...
#'     customSearch(custom_request = AND(String(section_or_field = "TO",
#'                                              string = "allan"),
...
#'     customSearch(custom_request = OR(String(section_or_field = "TEXT",
...
#' @export
#'
customSearch <- function(imapconf, custom_request, negate = FALSE,
                         by = "MSN", esearch = FALSE, return_imapconf = TRUE,
                         retries = 2){

  check_args_customSearch(imapconf, custom_request, negate, by, esearch,

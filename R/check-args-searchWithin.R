#' @title Within Search Arguments Check
#'
...
#' @keywords internal
#'
check_args_searchWithin <- function(imapconf, seconds, negate, by, flag, esearch,
  ...
  assertthat::assert_that(
    ...
    msg='"flag" argument must be NULL or a character. See mRpostman::flag_options()')

...
* **the query language (2.3.0)**: `query()` searches with plain R expressions, e.g. `con$query((subject == "budget" | "budget 3") & flag != "SEEN")`, translated to RFC 3501 search strings by a pure internal function; criterion constructors also combine with the native `&`, `|`, and `!`;

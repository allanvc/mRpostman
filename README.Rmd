...
based on the RFC 3501 manual (Crispin, 2003), its updates, and other related 
documents. This package makes extensive use of 'curl' and libcurl capabilities 
to provide functions for listing, selecting and renaming mailboxes, as well as 
moving, fetching, and searching messages using several criteria.
...
This extracts and decode your `base64` text attachments from messages, and save them locally.

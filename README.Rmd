...
such as listing mailboxes, searching and fetching messages by several 
...
* **miscellania**: `copyMsg()`, `getMinId()`, `getMaxId()`, `deleteMsg()`, `expunge()`, `addFlags()`,
`removeFlags()`, `replaceFlags()`, `moveMsg()`.

...
`fetch_metadata()`, `fetch_preview()`, `metadata_options()`, `fetch_attachments_list()`, `fetch_attachments()`;
...
* **MIME-decoding and message-text helper functions**: `decode_mime_header()`, `clean_msg_text()`.

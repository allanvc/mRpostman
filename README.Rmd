...
* **server information methods**: `list_server_capabilities()`, `id()`, `namespace()`, `get_quota_root()`, `get_quota()`;
* **mailbox operations methods**: `list_mail_folders()`, `list_subscribed_folders()`, `list_special_use_folders()`, `select_folder()`, `examine_folder()`, `status()`, `create_folder()`, `rename_folder()`, `delete_folder()`, `subscribe_folder()`, `unsubscribe_folder()`, `close_folder()`, `unselect_folder()`, `list_flags()`;

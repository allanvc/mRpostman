...
* **complementary methods**: `copy_msg()`, `move_msg()`, `append_msg()`, `append_msgs()`, `idle()`, `esearch_min_id()`, `esearch_max_id()`, `esearch_count()`, `delete_msg()`, `expunge()`, `add_flags()`, `remove_flags()`, `replace_flags()`;
